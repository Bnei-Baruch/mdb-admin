...
class Tags extends Component {
  ...
  renderStatusMessage() {
    ...
    if (status.addTag.wip) {
      return <Header content="Adding Tag..." icon={{ name: 'spinner', loading: true }} size="tiny" />;
    } else if (status.removeTag.wip) {
      return <Header content="Removing Tag..." icon={{ name: 'spinner', loading: true }} size="tiny" />;
    }
